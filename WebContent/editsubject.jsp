					...
					<div class="form-group">
						<label for="Subject">Subject ID:</label>
						 <input type="text"
							...
							placeholder="Enter the Subject ID" name="subject_id" value="${requestScope.subject.subject_id}" disabled>
					</div>
					<div class="form-group">
						<label for="question">Subject Name:</label> <input type="text"
							class="form-control" id="name"
							placeholder="Enter the Subject Name" name="name" value="${requestScope.subject.name}">
					</div>
					<button type="submit" name="action" value="EditSubject"
