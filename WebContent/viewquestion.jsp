...
<body>
	...
	<ul class="list-group">
		...
		<li class="list-group-item">Question :
			${requestScope.quesn.question}</li>
		<li class="list-group-item">Choice 1 :
			${requestScope.quesn.choice1}</li>
		<li class="list-group-item">Choice 2 :
			${requestScope.quesn.choice2}</li>
		<li class="list-group-item">Choice 3 :
			${requestScope.quesn.choice3}</li>
		<li class="list-group-item">Choice 4 :
			${requestScope.quesn.choice4}</li>
		<li class="list-group-item">Answer : ${requestScope.quesn.answer}</li>
