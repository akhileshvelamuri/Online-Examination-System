...
<body>
	...
	<ul class="list-group">
		...
		<li class="list-group-item">Test ID: ${requestScope.tst.test_id}</li>
		<li class="list-group-item">Test Name : ${requestScope.tst.name}</li>
		<li class="list-group-item">Duration :
			${requestScope.tst.duration}</li>
		<li class="list-group-item">Maximum Score :
			${requestScope.tst.max_score}</li>
		<li class="list-group-item">Subject ID :
			${requestScope.tst.subject_id}</li>
