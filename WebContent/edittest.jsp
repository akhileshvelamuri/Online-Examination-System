		...
		<form action="OESController" method="post">
			...
			<h3>Edit Test</h3>
					<div class="form-group">
						...
						<input type="text"
							class="form-control" id="test_id"
							placeholder="Enter the Test ID" name="test_id" value="${requestScope.test.test_id}" disabled>
					</div>
					<div class="form-group">
						<label for="name">Test Name:</label> <input type="text"
							class="form-control" id="name"
							placeholder="Enter the Test Name" name="name" value="${requestScope.test.name}">
					</div>
					<div class="form-group">
						<label for="duration">Duration:</label> <input type="text"
							class="form-control" id="duration"
							placeholder="Enter the Duration of the Test" name="duration" value="${requestScope.test.duration}">
					</div>
					<div class="form-group">
						<label for="max_score">Maximum Score:</label> <input type="text"
							class="form-control" id="max_score"
							placeholder="Enter the Maximum Score" name="max_score" value="${requestScope.test.max_score}">
					</div>
					<div class="form-group">
					...
					<button type="submit" name="action" value="EditTest"
