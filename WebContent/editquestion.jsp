		...
		<form action="OESController" method="post">
			...
			<h3>Edit Question</h3>
					<%-- <div class="form-group">
						<label for="question_id">Question ID:</label> <input type="text"
							class="form-control" id="question_id" name="question_id" value="${requestScope.question.question_id}" disabled>
					</div> --%>
					<div class="form-group">
					<input type="hidden" id="question_id" name="question_id" value="${requestScope.question.question_id}">
					</div>
					<div class="form-group">
						<label for="question">Question:</label> <input type="text"
							class="form-control" id="question"
							placeholder="Enter the Question" name="question" value="${requestScope.question.question}">
					</div>
					<div class="form-group">
						<label for="choice1">Choice 1:</label> <input type="text"
							class="form-control" id="choice1" placeholder="Choice 1"
							name="choice1" value="${requestScope.question.choice1}">
					</div>
					<div class="form-group">
						<label for="choice2">Choice 2:</label> <input type="text"
							class="form-control" id="choice2" placeholder="Choice 2"
							name="choice2" value="${requestScope.question.choice2}">
					</div>
					<div class="form-group">
						<label for="choice3">Choice 3:</label> <input type="text"
							class="form-control" id="choice3" placeholder="Choice 3"
							name="choice3" value="${requestScope.question.choice3}">
					</div>
					<div class="form-group">
						<label for="choice4">Choice 4:</label> <input type="text"
							class="form-control" id="choice4" placeholder="Choice 4"
							name="choice4" value="${requestScope.question.choice4}">
					</div>
					<div class="form-group">
						<label for="answer">Answer:</label> <input type="text"
							class="form-control" id="answer" placeholder="Answer"
							name="answer" value="${requestScope.question.answer}">
					</div>
					<div class="form-group">
						<label for="marks">Marks:</label> <input type="text"
							class="form-control" id="marks"
							placeholder="Marks for the Question" name="marks"
							value="${requestScope.question.marks}">
					</div>
					<div class="form-group">
					...
					<button type="submit" name="action" value="EditQuestion"
